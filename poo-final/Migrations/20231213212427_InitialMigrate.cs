    ...
    public partial class InitialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PratoPedidos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PratoPedidos_Pedidos_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "Pedidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PratoPedidos_Pratos_PratoId",
                        column: x => x.PratoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PratoPedidos_PedidoId",
                table: "PratoPedidos",
                column: "PedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_PratoPedidos_PratoId",
                table: "PratoPedidos",
                column: "PratoId");
        }
